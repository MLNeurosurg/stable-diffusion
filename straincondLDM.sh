...
python main.py --base configs/latent-diffusion/SRH-ldm-vq-f8-condition.yaml -r ../../experiment/ldm/logs/2022-10-14T15-11-55_SRH-ldm-vq-f8-condition -l /nfs/turbo/umms-tocho/code/achowdur/experiment/ldm/logs -p condldm -t True --gpus 0,1,2,
